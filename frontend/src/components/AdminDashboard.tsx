    ...
    <div className="fixed inset-0 z-50 bg-[#111111]/90 backdrop-blur-md flex flex-col font-sans text-white overflow-hidden">
        ...
        <div className="flex items-center space-x-3 text-xs">
          ...
          <div className="relative hidden md:block">
            ...
            <input
              ...
              className="bg-black/50 text-xs pl-8 pr-4 py-1.5 rounded-xl border border-white/10 text-white placeholder-gray-400 outline-none focus:border-[#E9C349] w-64"
            />
          </div>
          ...
          <button
            ...
            className="px-2.5 py-1.5 rounded-xl bg-white/5 hover:bg-white/10 text-gray-300 font-mono text-xs uppercase transition-all border border-white/10 flex items-center space-x-1"
          >
          ...
          <button
            onClick={onClose}
            className="p-1.5 rounded-xl bg-red-500/20 text-red-400 hover:bg-red-500 hover:text-white transition-all border border-red-500/30 flex items-center space-x-1 font-bold px-3"
          >
            <X className="w-4 h-4" />
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <aside className="w-64 bg-[#111113] border-r border-white/10 flex flex-col justify-between shrink-0 overflow-y-auto p-3">
          <div className="space-y-1">
            <div className="px-3 py-2 text-[10px] font-mono text-gray-500 uppercase tracking-widest font-bold flex items-center justify-between">
            ...
            >
              ...
              {isInstructor && <Lock className="w-3.5 h-3.5 text-amber-400" title="Admin Only Page" />}
            </button>
            ...
            >
              ...
              {isInstructor ? (
                <Lock className="w-3.5 h-3.5 text-amber-400" title="Admin Only Page" />
              ) : (
            ...
            <div className="pt-3 px-3 py-2 text-[10px] font-mono text-gray-500 uppercase tracking-widest font-bold">
              System & CMS
            </div>
          ...
          <div className="pt-3 border-t border-white/10 mt-4">
            <div className="p-3 rounded-2xl bg-white/5 border border-white/10 flex items-center space-x-3">
              ...
              <div className="min-w-0 flex-1">
                <div className="text-xs font-bold text-white truncate">{currentUser?.fullName || 'Super Administrator'}</div>
                <div className="text-[10px] text-gray-400 font-mono">Role: {currentUser?.role || 'System Admin'}</div>
              </div>
            </div>
          </div>
        </aside>
        ...
        <main className="flex-1 bg-[#1A1A1E] text-gray-100 overflow-y-auto p-6">
          ...
          {(isUnauthenticated || isStudentOrApplicant) ? (
            <div className="max-w-2xl mx-auto py-16 px-6">
              <div className="p-8 rounded-3xl bg-[#161619] border border-[#E9C349]/40 shadow-2xl space-y-6 text-center">
                ...
                <div className="space-y-2">
                  ...
                  <h2 className="text-2xl font-serif font-bold text-white pt-1">
                ...
                <div className="pt-2 flex flex-col sm:flex-row items-center justify-center gap-3">
                  ...
                  <button
                    onClick={onClose}
                    className="w-full sm:w-auto px-5 py-2.5 rounded-xl bg-white/10 text-white font-semibold text-xs hover:bg-white/20 border border-white/10"
                  >
                    Exit Portal
                  </button>
                </div>
            ...
            <div className="max-w-3xl mx-auto py-12 px-6">
              <div className="p-8 rounded-3xl bg-[#161619] border border-amber-500/40 shadow-2xl space-y-6 text-center relative overflow-hidden">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-gray-300 max-w-lg mx-auto leading-relaxed">
                    Access to institute management pages (<span className="text-[#E9C349] font-mono font-bold uppercase">{activeTab}</span>) is restricted to <strong className="text-white">Admin</strong> role privileges. Your role is <strong className="text-[#E9C349]">Instructor</strong>, which is restricted to class-related activities.
                  </p>
                </div>

                {/* Authorized Class Activities Quick Links */}
                <div className="p-4 rounded-2xl bg-black/40 border border-white/10 text-left space-y-3">
                  <div className="text-[11px] font-mono text-gray-400 uppercase font-bold flex items-center space-x-1.5">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 text-xs">
                    <button
                      onClick={() => setActiveTab('students')}
                      className="p-2.5 rounded-xl bg-white/5 hover:bg-[#E9C349] hover:text-black border border-white/10 text-gray-200 transition-all font-semibold flex items-center space-x-2"
                    >
                ...
                <div className="pt-2 flex flex-col sm:flex-row items-center justify-center gap-3">
                  ...
                  {onOpenInstructorDashboard && (
                    <button
                      ...
                      className="w-full sm:w-auto px-5 py-2.5 rounded-xl bg-white/10 hover:bg-white/20 text-white font-bold text-xs flex items-center justify-center space-x-2 border border-white/10"
                    >
            ...
            <div className="space-y-6">
              {/* Dashboard Banner */}
              <div className="p-6 rounded-3xl bg-gradient-to-r from-[#111111] via-[#1F1F24] to-[#111111] border border-[#E9C349]/40 relative overflow-hidden flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4">
                <div className="p-4 rounded-2xl bg-[#161619] border border-white/10 hover:border-[#E9C349]/40 transition-all">
                  <span className="text-[10px] font-mono text-gray-400 uppercase font-bold">Total Students</span>
                  <div className="text-2xl font-mono font-bold text-white mt-1">1,455</div>
                  <span className="text-[10px] text-emerald-400 font-bold">+18.4% this term</span>
                </div>

                <div className="p-4 rounded-2xl bg-[#161619] border border-white/10 hover:border-[#E9C349]/40 transition-all">
                  <span className="text-[10px] font-mono text-gray-400 uppercase font-bold">Active Programs</span>
                  <div className="text-2xl font-mono font-bold text-[#E9C349] mt-1">5 Tracks</div>
                  <span className="text-[10px] text-gray-400">3 & 6 Months Duration</span>
                </div>

                <div className="p-4 rounded-2xl bg-[#161619] border border-white/10 hover:border-[#E9C349]/40 transition-all">
                  <span className="text-[10px] font-mono text-gray-400 uppercase font-bold">Instructors</span>
                  <div className="text-2xl font-mono font-bold text-white mt-1">14 Staff</div>
                  <span className="text-[10px] text-emerald-400 font-bold">100% Certified</span>
                </div>

                <div className="p-4 rounded-2xl bg-[#161619] border border-white/10 hover:border-[#E9C349]/40 transition-all">
                  <span className="text-[10px] font-mono text-gray-400 uppercase font-bold">Pending Admissions</span>
                ...
                <div className="p-4 rounded-2xl bg-[#161619] border border-white/10 hover:border-[#E9C349]/40 transition-all">
                  <span className="text-[10px] font-mono text-gray-400 uppercase font-bold">Certificates Issued</span>
                  <div className="text-2xl font-mono font-bold text-white mt-1">480+</div>
                  <span className="text-[10px] text-gray-400">COC Verified</span>
                </div>

                <div className="p-4 rounded-2xl bg-[#161619] border border-white/10 hover:border-[#E9C349]/40 transition-all">
                  <span className="text-[10px] font-mono text-gray-400 uppercase font-bold">Monthly Revenue</span>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <div className="lg:col-span-2 p-6 rounded-3xl bg-[#161619] border border-white/10">
                      ...
                      <tbody className="divide-y divide-white/5">
                        {students.slice(0, 5).map(s => (
                          <tr key={s.id} className="hover:bg-white/5">
                            ...
                            <td className="py-2 text-gray-300">{s.course}</td>
                            <td className="py-2">
                ...
                <div className="p-6 rounded-3xl bg-[#161619] border border-white/10">
                  <h3 className="text-sm font-bold text-white mb-4 flex items-center justify-between">
                  ...
                  <div className="space-y-3">
                    {logs.map(log => (
                      <div key={log.id} className="p-3 rounded-xl bg-black/40 border border-white/5 text-xs">
          ...
          {activeTab === 'students' && (
            <div className="space-y-6">
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                  <h2 className="text-xl font-bold font-serif text-white">Student Management Directory</h2>
                  <p className="text-xs text-gray-400">View, register, edit, or check official academic status for enrolled students.</p>
                </div>
                ...
                <div className="flex items-center space-x-2">
                  <button
                    ...
                    className="px-3.5 py-2 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white font-bold text-xs flex items-center space-x-1.5"
                  >
                  ...
                  <tbody className="divide-y divide-white/5">
                    {filteredStudents.map(s => (
                      <tr key={s.id} className="hover:bg-white/5 transition-colors">
                        ...
                        <td className="p-3.5 text-gray-300">{s.course}</td>
                        <td className="p-3.5 text-gray-400 font-mono">{s.duration}</td>
          ...
          {activeTab === 'admissions' && (
            <div className="space-y-6">
              <div>
                <h2 className="text-xl font-bold font-serif text-white">Online Application & Payment Verification</h2>
                <p className="text-xs text-gray-400">Review pending admissions, verify uploaded receipt screenshots, and assign registration numbers.</p>
              </div>

              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {applications.map((app) => (
                  <div key={app.id} className="p-5 rounded-3xl bg-[#161619] border border-white/10 flex flex-col justify-between space-y-4">
                    <div>
                      ...
                      <div className="mt-3 p-3 rounded-2xl bg-black/40 text-xs space-y-1 font-mono">
                        <div><span className="text-gray-500">Program:</span> {app.program}</div>
                        <div><span className="text-gray-500">Shift:</span> {app.shift} ({app.duration})</div>
                        <div><span className="text-gray-500">Applied:</span> {app.date}</div>
                      </div>
                    </div>
                    ...
                    <div className="space-y-2">
                      <button
                        ...
                        className="w-full py-2 rounded-xl bg-white/5 hover:bg-white/10 text-xs text-[#E9C349] font-semibold flex items-center justify-center space-x-1 border border-white/10"
                      >
          ...
          {activeTab === 'programs' && (
            <div className="space-y-6">
              <div className="flex items-center justify-between">
                <div>
                  <h2 className="text-xl font-bold font-serif text-white">Training Programs Curriculum</h2>
                  <p className="text-xs text-gray-400">Manage 3-month and 6-month vocational qualification tracks & syllabus units.</p>
                </div>
              </div>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {programs.map(p => (
                  <div key={p.id} className="p-6 rounded-3xl bg-[#161619] border border-white/10 space-y-4">
                    <div className="flex items-center justify-between">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-400 font-serif italic mt-0.5">{p.amharicName}</p>
                    </div>

                    <div className="p-3 rounded-2xl bg-black/40 text-xs space-y-1 font-mono text-gray-300">
                      <div><span className="text-gray-500">Units Included:</span> {p.units} Practical Modules</div>
                      <div><span className="text-gray-500">Lead Instructor:</span> {p.instructor}</div>
                    </div>
                  </div>
                ))}
              </div>
          ...
          {activeTab === 'instructors' && (
            <div className="space-y-6">
              <div>
                <h2 className="text-xl font-bold font-serif text-white">Instructor Faculty Roster</h2>
                <p className="text-xs text-gray-400">Assigned beauty professionals and master trainers.</p>
              </div>

              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                {instructors.map(ins => (
                  <div key={ins.id} className="p-5 rounded-3xl bg-[#161619] border border-white/10 text-center space-y-3">
          ...
          {activeTab === 'attendance' && (
            <div className="space-y-6">
              ...
              <div>
                <h2 className="text-xl font-bold font-serif text-white">Daily Practical & Theory Attendance Register</h2>
                <p className="text-xs text-gray-400">Monitor student attendance logs and minimum 75% COC compliance alerts.</p>
              </div>

              <div className="bg-[#161619] rounded-3xl border border-white/10 p-6">
                <table className="w-full text-left text-xs">
                  <thead>
                    <tr className="text-[#E9C349] font-mono text-[10px] uppercase border-b border-white/10">
                      <th className="py-3">Student Name</th>
                      <th className="py-3">Course Track</th>
                      <th className="py-3">Attendance Rate</th>
                      <th className="py-3">COC Compliance</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-white/5">
                    {students.map(s => (
                      <tr key={s.id}>
                        ...
                        <td className="py-3 text-gray-300">{s.course}</td>
                        <td className="py-3 font-mono font-bold text-white">{s.attendance}%</td>
                        <td className="py-3">
                          <span className={`px-2 py-0.5 rounded-full text-[10px] font-bold ${s.attendance >= 75 ? 'bg-emerald-500/20 text-emerald-400' : 'bg-red-500/20 text-red-400'}`}>
                            {s.attendance >= 75 ? 'Eligible for COC' : 'Flagged Below 75%'}
                          </span>
                        </td>
                      </tr>
                    ))}
          ...
          {activeTab === 'grades' && (
            <div className="space-y-6">
              <div>
                <h2 className="text-xl font-bold font-serif text-white">Practical Competency & Transcript Center</h2>
                <p className="text-xs text-gray-400">Grade practical assessments and generate transcripts.</p>
              </div>
          ...
          {activeTab === 'certificates' && (
            <div className="space-y-6">
              <div className="flex items-center justify-between">
                <div>
                  <h2 className="text-xl font-bold font-serif text-white">Official Certificate Generator & Verification</h2>
                  <p className="text-xs text-gray-400">Issue accredited certificates for completed training programs.</p>
                </div>
              </div>

              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {certificates.map(c => (
                  <div key={c.certNo} className="p-5 rounded-3xl bg-[#161619] border border-[#E9C349]/40 space-y-3">
                    <div className="flex items-center justify-between">
                    ...
                    <div>
                      <h3 className="text-base font-bold text-white">{c.studentName}</h3>
                      <p className="text-xs text-gray-400">{c.program}</p>
                    </div>

                    <div className="p-2.5 rounded-xl bg-black/40 text-[11px] font-mono text-gray-300">
          ...
          {activeTab === 'fees' && (
            <div className="space-y-6">
              <div>
                <h2 className="text-xl font-bold font-serif text-white">Tuition & Financial Receipts Log</h2>
                <p className="text-xs text-gray-400">Track paid installments, outstanding balances, and financial summaries.</p>
              </div>
          ...
          {activeTab === 'reports' && (
            <div className="space-y-6">
              <div>
                <h2 className="text-xl font-bold font-serif text-white">Institute Export & PDF Reports Manager</h2>
                <p className="text-xs text-gray-400">Export formatted CSV spreadsheets and printable PDF administrative summaries.</p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="p-6 rounded-3xl bg-[#161619] border border-white/10 space-y-3">
                  ...
                  <p className="text-xs text-gray-400">Export active student lists with UTF-8 BOM encoding for Excel.</p>
                  <button
                ...
                <div className="p-6 rounded-3xl bg-[#161619] border border-white/10 space-y-3">
                  ...
                  <p className="text-xs text-gray-400">Generate formatted official printable PDF administrative report.</p>
                  <button
          ...
          {activeTab === 'cms' && (
            <div className="space-y-6">
              <div>
                <h2 className="text-xl font-bold font-serif text-white">Website Content Management System (CMS)</h2>
                <p className="text-xs text-gray-400">Manage FAQs, announcements, gallery images, and landing page content.</p>
              </div>

              <div className="p-6 rounded-3xl bg-[#161619] border border-white/10 space-y-4">
                <h3 className="text-sm font-bold text-white">Manage Frequently Asked Questions (FAQs)</h3>
                <div className="space-y-3">
                  {faqs.map(faq => (
                    <div key={faq.id} className="p-4 rounded-2xl bg-black/40 border border-white/5">
                      <div className="font-bold text-white text-xs">{faq.question}</div>
                      <div className="text-xs text-gray-400 mt-1">{faq.answer}</div>
                    </div>
                  ))}
                </div>
              </div>
          ...
          {activeTab === 'users' && (
            <div className="space-y-6">
              <div>
                <h2 className="text-xl font-bold font-serif text-white">User Accounts & Role Permissions</h2>
                <p className="text-xs text-gray-400">Manage administrative roles, instructors, registrars, and student accounts.</p>
              </div>
          ...
          {activeTab === 'security' && (
            <div className="space-y-6">
              <div>
                <h2 className="text-xl font-bold font-serif text-white">Security Audit Trail & Prisma Database Backup</h2>
                <p className="text-xs text-gray-400">View access history and database status.</p>
              </div>
              ...
              <div className="p-6 rounded-3xl bg-[#161619] border border-white/10 space-y-3">
                ...
                <p className="text-xs text-gray-400">Encrypted multi-region backup configured.</p>
              </div>
            </div>
          )}
            </>
      ...
      {selectedReceiptUrl && (
        <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-md flex items-center justify-center p-4">
          <div className="bg-[#161619] border border-[#E9C349]/40 rounded-3xl p-6 max-w-lg w-full text-center space-y-4">
            <div className="flex items-center justify-between text-white border-b border-white/10 pb-3">
              <h3 className="text-sm font-bold">Payment Telebirr/Bank Receipt</h3>
              <button onClick={() => setSelectedReceiptUrl(null)} className="p-1 text-gray-400 hover:text-white">
                <X className="w-5 h-5" />
              </button>
            </div>
            <img src={selectedReceiptUrl} alt="Receipt Screenshot" className="max-h-80 mx-auto rounded-2xl border border-white/10 object-cover" />
            <button
      ...
      {addStudentModalOpen && (
        <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-md flex items-center justify-center p-4">
          <div className="bg-[#161619] border border-[#E9C349]/40 rounded-3xl p-6 max-w-md w-full space-y-4">
            <div className="flex items-center justify-between text-white border-b border-white/10 pb-3">
              <h3 className="text-base font-bold font-serif">Register New Student</h3>
              <button onClick={() => setAddStudentModalOpen(false)} className="p-1 text-gray-400 hover:text-white">
                <X className="w-5 h-5" />
              </button>
            </div>
            ...
            <form onSubmit={handleAddStudentSubmit} className="space-y-3 text-xs">
              <div>
                ...
                <input
                  ...
                  className="w-full p-2.5 rounded-xl bg-black/50 border border-white/10 text-white outline-none focus:border-[#E9C349]"
                />
              </div>
              ...
              <div>
                <label className="block text-gray-300 font-bold mb-1">Course Program</label>
                <select
              ...
              <div className="pt-2 flex items-center space-x-2">
                ...
                <button
                  ...
                  className="py-2.5 px-4 rounded-xl bg-white/10 text-white font-semibold text-xs"
                >
                  Cancel
                </button>
              </div>
        ...
        <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-md flex items-center justify-center p-4">
          <div className="bg-[#FAF8F5] text-black border-4 border-[#D4AF37] rounded-3xl p-8 max-w-xl w-full text-center space-y-4 shadow-2xl relative font-serif">
            ...
            <div className="my-6 border-t border-b border-[#D4AF37]/40 py-4">
              <div className="text-xs font-sans text-gray-500">This is to certify that</div>
              <div className="text-2xl font-bold text-black my-1">{selectedCertPrint.studentName}</div>
              <div className="text-xs font-sans text-gray-500">has successfully completed the accredited program in</div>
