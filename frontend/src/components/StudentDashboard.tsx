          ...
          {activeTab === 'attendance' && (
            <div className="space-y-6">
              ...
              <AttendanceHeatmap
                ...
                themeMode={themeMode}
                selectedStudentId={currentUser?.name?.includes('Helen') ? 'ST-2026-012' : currentUser?.name?.includes('Eyerus') ? 'ST-2026-034' : currentUser?.name?.includes('Dawit') ? 'ST-2026-089' : 'ST-2026-005'}
                isEmbedded={true}
              />
